 ...
 */
final class Version20260326212610 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, CHANGE email email VARCHAR(40) DEFAULT NULL, CHANGE password password VARCHAR(40) DEFAULT NULL');
    }
}
