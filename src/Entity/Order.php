...
class Order
{
     ...
     */
    #[ORM\OneToMany(targetEntity: CommandLine::class, mappedBy: 'orderNumb')]
    ...
    public function removeCommandLine(CommandLine $commandLine): static
    {
        if ($this->commandLines->removeElement($commandLine)) {
            ...
            if ($commandLine->getOrderNumb() === $this) {
                $commandLine->setOrderNumb(null);
            }
        }
